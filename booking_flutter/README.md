# Flutter Mobile & Desktop Application - Mini Booking System

Flutter приложение для iOS, Android, Windows и macOS для системы бронирования отелей.
...
- ✅ Статус каждого номера (свободно/занято)
- ✅ Ближайшая бронь для каждого отеля
